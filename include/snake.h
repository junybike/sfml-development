...
// To represent position of each snake's body in the grid
struct SnakeSegment
{
...
{
public:
    Snake(int l_block_size, Textbox* l_log);    // The snake constructor
    ~Snake();                                   // The snake destructor
    ...
    void ToggleLost();                          // Toggle the lose event
    ...
    void Render(sf::RenderWindow& l_window);    // Update and color the snake's body location
...
private:
    ...
    Textbox* m_log;     // The textbox attribute
};
