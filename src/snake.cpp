...
// Set snake's body to default length and position
void Snake::Reset()
{
    m_snakebody.clear();
...
// Extends the length of snake by adding extra block to its body
void Snake::Extend()
{
...
// Check if the snake collides with its own body or wall
...
// Decrements snake body by one block
...
// Apply the new changes made to the snake. (location, length, direction, etc.)
